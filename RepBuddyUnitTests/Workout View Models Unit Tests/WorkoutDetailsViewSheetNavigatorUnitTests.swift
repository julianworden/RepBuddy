...
final class WorkoutDetailsViewSheetNavigatorUnitTests: XCTestCase {
    ...
    func test_OnEditSetButtonTapped_PropertiesAreModifiedProperly() {
        ...
        sut.editSetButtonTapped(for: testRepSet, in: testExercise)

        XCTAssertEqual(sut.sheetDestination, .addEditRepSetView(exercise: testExercise, repSetToEdit: testRepSet), "AddEditRepSetView should've been presented")
        XCTAssertTrue(sut.presentSheet, "The sheet should've been presented")
    }
    ...
    func test_OnAddSetButtonTapped_PropertiesAreModifiedProperly() {
        ...
        sut.addSetButtonTapped(for: testExercise)

        XCTAssertEqual(sut.sheetDestination, .addEditRepSetView(exercise: testExercise, repSetToEdit: nil), "AddEditRepSetView should've been presented")
        XCTAssertTrue(sut.presentSheet, "The sheet should've been presented")
