...
final class ExerciseRepsInWorkoutDetailsViewModelUnitTests: XCTestCase {
    ...
    func test_OnExerciseRepsInWorkoutDetailsViewModelInit_ValuesAreCorrect() {
        ...
        XCTAssertFalse(sut.addRepSetSheetIsShowing, "No sheets should be showing by default")
    ...
    func test_OnExerciseRepsInWorkoutDetailsViewModelDeleteRepSet_RepSetIsDeleted() throws {
        ...
        sut.deleteRepSet(in: testExercise, at: IndexSet(integer: 0))

        XCTAssertEqual(dataController.count(for: RepSet.fetchRequest()), 4, "Only 4 RepSets should exist")
