...
final class AddEditRepSetViewModelUnitTests: XCTestCase {
    ...
    func test_OnInitWithRepSetToEdit_ValuesAreCorrect() {
        ...
        XCTAssertEqual(Int(sut.repSetToEdit!.reps), sut.repSetCount, "The repSetToEdit's reps count should've been updated")
        XCTAssertEqual(Int(sut.repSetToEdit!.weight), sut.repSetWeight, "The repSetToEdit's weight should've been updated")
